...
public final class ActivitySongBinding implements ViewBinding {
  ...
  @NonNull
  public final TextView songMusicLyricsIv1;

  @NonNull
  public final TextView songMusicLyricsIv2;
  ...
  private ActivitySongBinding(@NonNull ConstraintLayout rootView, @NonNull ImageView songAlbumIv,
      ...
      @NonNull ImageButton songMoreIb, @NonNull TextView songMusicLyricsIv1,
      @NonNull TextView songMusicLyricsIv2, @NonNull TextView songMusicTitleTv,
    ...
    this.songMusicLyricsIv1 = songMusicLyricsIv1;
    this.songMusicLyricsIv2 = songMusicLyricsIv2;
  ...
  public static ActivitySongBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      id = R.id.song_music_lyrics_iv1;
      TextView songMusicLyricsIv1 = ViewBindings.findChildViewById(rootView, id);
      if (songMusicLyricsIv1 == null) {
        break missingId;
      }

      id = R.id.song_music_lyrics_iv2;
      TextView songMusicLyricsIv2 = ViewBindings.findChildViewById(rootView, id);
      if (songMusicLyricsIv2 == null) {
        break missingId;
      }
      ...
      return new ActivitySongBinding((ConstraintLayout) rootView, songAlbumIv, songDownIb,
          ...
          songMiniplayerIv, songMoreIb, songMusicLyricsIv1, songMusicLyricsIv2, songMusicTitleTv,
