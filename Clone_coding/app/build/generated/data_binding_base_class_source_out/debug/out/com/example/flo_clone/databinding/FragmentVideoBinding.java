...
public final class FragmentVideoBinding implements ViewBinding {
  ...
  private FragmentVideoBinding(@NonNull ConstraintLayout rootView, @NonNull TextView videoTv) {
  ...
  public static FragmentVideoBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      id = R.id.video_tv;
      TextView videoTv = ViewBindings.findChildViewById(rootView, id);
      if (videoTv == null) {
        break missingId;
      }

      return new FragmentVideoBinding((ConstraintLayout) rootView, videoTv);
    }
