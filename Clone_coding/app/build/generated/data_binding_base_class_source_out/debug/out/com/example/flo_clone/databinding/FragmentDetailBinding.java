...
public final class FragmentDetailBinding implements ViewBinding {
  ...
  private FragmentDetailBinding(@NonNull ConstraintLayout rootView, @NonNull TextView detailTv) {
  ...
  public static FragmentDetailBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new FragmentDetailBinding((ConstraintLayout) rootView, detailTv);
    }
