package com.example.flo_clone.ui.main
...
import com.example.flo_clone.ui.main.home.HomeFragment
import com.example.flo_clone.ui.main.locker.LockerFragment
import com.example.flo_clone.ui.main.look.LookFragment
import com.example.flo_clone.R
import com.example.flo_clone.ui.main.search.SearchFragment
...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        KakaoSdk.init(this, "47ef59742e4eb6c01ffcc461ebd97546")
        ...
        Log.d("KAKAO_KEY_HASH","카카오 키 해시 : : $keyHash")
    ...
    private fun inputDummySongs() {
        ...
        songDB?.songDao()?.insert(
            Song("BBoom BBoom", "모모랜드(MOMOLAND)", 0, 240, false, "iu_lilac",
